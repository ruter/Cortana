...
async def ensure_user_exists(user_id: int) -> None:
    ...
    # ⚡ Bolt Optimization: Cache user existence to avoid redundant sync DB calls
    ...
    try:
        ...
        # Add to cache after successful check/insert
        ...
        if "duplicate" not in str(e).lower():
            ...
            # Even if it was a duplicate error, the user exists now, so cache it
            _known_users.add(user_id)
